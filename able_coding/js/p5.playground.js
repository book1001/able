  ...
  window.setup = function() {
    ...
    for(var i = 0; i < myShapes.length; i++){
      ...
      if(myShapes[i].type == 'rect'){
        ...
        fillColorStr = '#ffffff';  // Halim fill color
      }
        ...
        strokeColorStr = '#000000'; // Halim stroke color
      }
        ...
        strokeWeightNum = '20'; // Halim stroke weight
      }
      else if(myShapes[i].type == 'noFill'){
        s.addShape(new NoFill());
        fillColorStr = 'none'; // Halim Do not chance
      }
...
function CanvasState(canvas){
  ...
  canvas.addEventListener('dblclick', function(e) {
    ...
    //add new triangle // Halim able: b
    if(addState === 'addTriangle'){
      console.log('adding a rect');
        var rect = new Shape(myState, mouse.x - 20, mouse.y - 20, 100, 60, fillColorStrBlack, strokeColorStr, strokeWeightNumNone);

        myState.addShape(rect);
        //push new x, y, w, h to myShapes[]
        var newCoordinates = [mouse.x - 20, mouse.y - 20, 100, 60];
        myShapes.push({
          type: 'rect',
          coordinates: newCoordinates
        });
      ...
      var ellipse = new Ellipse(myState, mouse.x, mouse.y, 100, 100, fillColorStr, strokeColorStr, strokeWeightNum);

      myState.addShape(ellipse);
      //push new x, y, w, h to myShapes[]
      var newCoordinates = [mouse.x, mouse.y, 100, 100];
      myShapes.push({
        type: 'ellipse',
        coordinates: newCoordinates
      });
    ...
    //   console.log('adding a rect');
    //   var rect = new Shape(myState, mouse.x - 20, mouse.y - 20, 100, 60, fillColorStr, strokeColorStr, strokeWeightNum);
    //
    //   myState.addShape(rect);
    //   //push new x, y, w, h to myShapes[]
    //   var newCoordinates = [mouse.x - 20, mouse.y - 20, 100, 60];
    ...
    //add new rect, 40, 40 // Halim able: a
    else if(addState === 'addRect'){
      console.log('adding a rect');
        var rect = new Shape(myState, mouse.x - 20, mouse.y - 20, 100, 60, fillColorStrBlack, strokeColorStr, strokeWeightNumNone);
