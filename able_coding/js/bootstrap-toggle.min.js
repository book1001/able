...
+ function(a) {
    ...
    c.VERSION = "2.2.0", c.DEFAULTS = {
        ...
        return {
            ...
            on: this.$element.attr("data-on") || c.DEFAULTS.off,
            off: this.$element.attr("data-off") || c.DEFAULTS.on,
            onstyle: this.$element.attr("data-onstyle") || c.DEFAULTS.offstyle,
            offstyle: this.$element.attr("data-offstyle") || c.DEFAULTS.onstyle,
